...
class UserProfiles(User):
    ...
    #手机号
    mobile = models.CharField(verbose_name='手机号',max_length=128,null=True)
    tel =  models.CharField(verbose_name='电话',max_length=128,null=True)
    #部门
    ...
    valid_begin_time = models.DateField(verbose_name='账户生效日期',blank=True,null=True)
    valid_end_time = models.DateField(verbose_name='账户失效日期',blank=True)
    is_admin = models.BooleanField(verbose_name='是否为管理员',default=False)
    token = models.CharField(verbose_name='秘钥',max_length=32)
    def __str__(self):
        return self.name
    class Meta:
        verbose_name = '成员'
...
class Group(models.Model):
    ...
    #负责人
    owner = models.ForeignKey(UserProfiles,verbose_name='负责人')
    #备注
...
class Asset(models.Model):
    ...
    admin = models.ForeignKey('UserProfiles', verbose_name='资产管理员', null=True, blank=True)
    memo = models.TextField(u'备注', null=True, blank=True)
...
class Tag(models.Model):
    ...
    creater = models.ForeignKey('UserProfiles')
    create_date = models.DateField(auto_now_add=True)
    def __str__(self):
        return self.name
...
class EventLog(models.Model):
    ...
    user = models.ForeignKey('UserProfiles',verbose_name=u'事件源')
    memo = models.TextField(u'备注', blank=True,null=True)
...
class NewAssetApprovalZone(models.Model):
    ...
    approved_by = models.ForeignKey('UserProfiles',verbose_name=u'批准人',blank=True,null=True)
