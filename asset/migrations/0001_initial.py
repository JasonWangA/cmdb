# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2016-11-29 16:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=64, unique=True)),
                ('parent_unit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='asset.BusinessUnit')),
            ],
        ),
        migrations.CreateModel(
            name='Contract',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('firmware', models.CharField(blank=True, max_length=64, null=True, verbose_name='固件')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile', models.CharField(max_length=128, null=True, verbose_name='手机号')),
                ('tel', models.CharField(max_length=128, null=True, verbose_name='电话')),
                ('secret_key', models.TextField(verbose_name='密钥')),
                ('memo', models.TextField(blank=True, null=True, verbose_name='备注')),
                ('create_date', models.DateField(auto_now=True, verbose_name='注册时间')),
                ('valid_begin_time', models.DateField(blank=True, verbose_name='账户生效日期')),
                ('valid_end_time', models.DateField(blank=True, verbose_name='账户失效日期')),
                ('is_admin', models.BooleanField(default=False, verbose_name='是否为管理员')),
                ('token', models.CharField(max_length=32, verbose_name='秘钥')),
                ('department', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='asset.Group', verbose_name='部门')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='tag',
            name='creater',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='asset.UserProfiles'),
        ),
        migrations.AddField(
            model_name='newassetapprovalzone',
            name='approved_by',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='asset.UserProfiles', verbose_name='批准人'),
        ),
        migrations.AddField(
            model_name='group',
            name='owner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='asset.UserProfiles', verbose_name='负责人'),
        ),
        migrations.AddField(
            model_name='eventlog',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='asset.UserProfiles', verbose_name='事件源'),
        ),
        migrations.AddField(
            model_name='asset',
            name='admin',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='asset.UserProfiles', verbose_name='资产管理员'),
        ),
        migrations.AddField(
            model_name='asset',
            name='business_unit',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='asset.BusinessUnit'),
        ),
        migrations.AddField(
            model_name='asset',
            name='contract',
