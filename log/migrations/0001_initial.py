    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='userinfo.UserProfile', verbose_name='事件源')),
            ],
            options={
                'verbose_name': '资产事件纪录',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_type', models.SmallIntegerField(choices=[(1, '执行命令'), (2, '分发文件'), (3, '服务部署'), (4, '用户管理'), (5, '部门管理')], verbose_name='操作类型')),
                ('detail', models.TextField(verbose_name='事件详情')),
                ('date', models.DateTimeField(auto_now_add=True, verbose_name='事件时间')),
                ('memo', models.TextField(blank=True, null=True, verbose_name='备注')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='userinfo.UserProfile', verbose_name='操作人')),
            ],
            options={
                'verbose_name': '用户操作纪录',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='userinfo.UserProfile', verbose_name='用户')),
            ],
            options={
                'verbose_name': '用户登录纪录',
